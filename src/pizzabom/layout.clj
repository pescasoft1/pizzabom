(ns pizzabom.layout
  (:require
   ...
   [pizzabom.models.crud :refer [config]]
   [pizzabom.models.util :refer [user-level user-name]]
   [pizzabom.menu :as menu]
...
(defn menus-private [request]
  (let [{:keys [nav-links dropdowns]} (pizzabom.menu/get-menu-config)]
