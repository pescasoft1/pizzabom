(defproject pizzabom "0.1.0"
  :description "pizzabom"
  ...
  :plugins [[lein-ancient "0.7.0"]
            [lein-pprint "1.3.2"]]
  :uberjar-name "pizzabom.jar"
  :target-path "target/%s"
  :ring {:handler pizzabom.core
         :auto-reload? true
         :auto-refresh? false}
  :resource-paths ["shared" "resources"]
  :aliases {"migrate"  ["run" "-m" "pizzabom.migrations/migrate" "--"]
            "rollback" ["run" "-m" "pizzabom.migrations/rollback" "--"]
            ...
            "database" ["run" "-m" "pizzabom.models.cdb/database" "--"]
            ;; Seed all tables except users
            ;;   lein seed-non-users
            ;;   lein seed-non-users pg
            ;;   lein seed-non-users localdb
            "seed-non-users" ["run" "-m" "pizzabom.models.cdb/seed-non-users" "--"]
            "scaffold" ["run" "-m" "pizzabom.engine.scaffold"]
            ...
            "convert-migrations" ["run" "-m" "pizzabom.db.converter" "--"]
            ...
            "copy-data" ["run" "-m" "pizzabom.db.migrator" "--"]
            ...
            "gen-handler" ["run" "-m" "pizzabom.gen.handler" "--"]}
